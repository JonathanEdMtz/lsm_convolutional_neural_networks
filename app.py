...
MODEL_PATH = 'data/models/train_cnn_v1.h5' if os.path.exists('data/models/train_cnn_v1.h5') else 'train_cnn_v1.h5'
...
if hasattr(mp, 'solutions') and hasattr(mp.solutions, 'hands'):
    ...
    TASK_PATH = 'hand_landmarker.task' if os.path.exists('hand_landmarker.task') else 'data/models/hand_landmarker.task'
